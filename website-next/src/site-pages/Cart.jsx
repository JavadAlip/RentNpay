  ...
  if (items.length === 0) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-16 text-center">
        ...
        <Link href="/products" className="text-primary font-medium hover:underline">Browse products</Link>
      </div>
    );
  }
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div>
          <div className="p-6 bg-gray-50 rounded-xl border border-gray-200 sticky top-24">
            ...
            <Link href="/products" className="mt-3 block text-center text-primary text-sm hover:underline">Continue shopping</Link>
          </div>
        </div>
      </div>
    </div>
